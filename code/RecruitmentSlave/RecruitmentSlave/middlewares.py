...
import os
import logging
from RecruitmentSlave.src import Proxies
from datetime import datetime, timedelta
from twisted.web._newclient import ResponseNeverReceived
from twisted.internet.error import TimeoutError, ConnectionRefusedError, ConnectError
from RecruitmentSlave.settings import user_agent_list


class RecruitmentslaveSpiderMiddleware(object):
...
class RecruitmentslaveDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
...
class HttpProxyMiddleware(object):
    ...
    def __init__(self, settings):
        ...
        self.proxy_file = "RecruitmentSlave/src/proxies.dat"
        # 是否在超时的情况下禁用代理
